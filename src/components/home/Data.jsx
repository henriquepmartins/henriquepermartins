...
const Data = () => {
    return (
       <div className="home__data">
        ...
        <p className="home__description">Getting deeper in back and frontend development, showcasing a passion for problem-solving and collaboration in software development.</p>
       <br />
